...
define('bar_pro_url','http://paratheme.com/items/banner-ads-rotator-rotate-unlimited-random-ads-banner/' );
define('bar_demo_url', 'http://paratheme.com/demo/banner-ads-rotator/' );
define('bar_conatct_url', 'http://paratheme.com/contact' );
define('bar_qa_url', 'http://paratheme.com/qa/' );
